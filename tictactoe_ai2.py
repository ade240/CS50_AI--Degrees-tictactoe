...
def result(board, action):
    ...
    """
    # Create new board, without modiyfing the original board recieved as input
...
def winner(board):
    ...
    # Check columns
        ...
        return board[0][1]
    elif board[0][0] == board[1][0] and board[1][2] == board[2][2]:
        return board[0][2]
    # Check diagonals
...
def utility(board):
    ...
    if terminal(board):
        if winner(board) == X:
            ...
            return 0
        # Check how to handle exception when a non terminal board is recieved.
